...
DETECTORES = {
    ...
    "yolo11s": dict(arq="yolo11s_416x640.onnx", entrada=(416, 640), thr=0.25,
                    retrato=dict(arq="yolo11s_640x416.onnx", entrada=(640, 416))),
}
POSES = {
...
class Detector:
    ...
    deitada 640x416 ocupa ~37% da largura, e a pessoa do fundo chega pequena.
    Na variante em pe (416x640) o mesmo quadro ocupa ~90%.

    A variante em pe e OPCIONAL: sem o arquivo, todo quadro usa a deitada -
    o comportamento anterior. O codigo pode subir antes do modelo.
    """
